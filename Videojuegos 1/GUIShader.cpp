...
GUIShader::GUIShader(std::string vsSource, std::string psSource) : Shader(ShaderType::GUIShader) {
	Initialize(vsSource, psSource);
}

bool GUIShader::Initialize(const std::string& vsSource, const std::string& psSource)
{
